...
Expected folder structure (one per mode):
    ...
    runs/learned_hybrid/logs/log.json
    runs/learned_loss_weighted/logs/log.json
...
LABELS["learned_loss_weighted"] = "Learned p(t; theta) - loss weighted"
LABELS["learned_hybrid"] = "Learned p(t; theta) - hybrid"
COLORS["learned_loss_weighted"] = "#7A5CFF"
COLORS["learned_hybrid"] = "#2AA7A5"
